...
Die App kann sowohl mit als auch ohne Internetverbindung benutzt werden. Im Offlinemodus sind keine Funktionen verfügbar, die eine Verbindung zum \Gls{Server} benötigen. Im Offlinemodus sind alle anderen Funktionen verfügbar. Insbesondere sind Kartennavigation, Etagennavigation, Ortungsfunktion und die Suchfunktion verfügbar.
