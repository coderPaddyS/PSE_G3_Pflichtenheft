...
\label{/FA31/}
Diese funktionale Anforderung wird durch die Testfälle \hyperref[/T80/]{/T80/}, \hyperref[/T100/]{/T100/}, \hyperref[/T110/]{/T110/} getestet.
...
\begin{enumerate}
    ...
    \item Erhält die App Standortzugriff oder besitzt sie ihn bereits, wird der aktuelle Standort auf der \Gls{Karte} angezeigt. Die \Gls{Karte} wird so verschoben, dass sich der aktuelle Standort in der Mitte befindet.
\end{enumerate}

\subsection*{/FA32/ Ortung beim Start der Applikation}
\label{/FA32/}
Diese funktionale Anforderung wird durch den Testfall \hyperref[/T100/]{/T100/} getestet.
\paragraph{Auslösendes Ereignis}
...
\begin{enumerate}
    ...
    \item Besitzt die App Standortzugriff, wird der aktuelle Standort auf der \Gls{Karte} angezeigt. Der aktuelle Standort befindet sich in der Mitte der angezeigten \Gls{Karte}.
\end{enumerate}