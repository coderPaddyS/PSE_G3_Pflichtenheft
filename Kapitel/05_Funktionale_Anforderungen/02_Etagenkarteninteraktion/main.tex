...
\begin{enumerate}
    ...
    \item Die \Gls{Etagenkarte} ist \gls{offline} verfügbar.Die \Gls{Etagenkarte} und die Kartendaten (Raumnummern) sind daher \gls{lokal} auf dem \Gls{Endgeraet} gespeichert.
\end{enumerate}
...
\begin{enumerate}[start=22, label=\textbf{/FA\arabic*/}, align=left]
    ...
    Die App erfragt die Information, wessen Büro es ist, von den \Gls{KIT}-Servern über das Internet. 
