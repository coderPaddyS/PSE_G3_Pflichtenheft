...
\begin{enumerate}[start=12, label=\textbf{/FA\arabic*/}, align=left]
    ...
    \item \label{/FA15/} Der \Gls{Benutzer} kann die \Gls{Karte} mit zwei Fingern drehen. Es wird ein Kompass angezeigt, der die Himmelsrichtung relativ zu \Gls{Karte} anzeigt. Diese funktionale Anforderung wird durch Testfall \hyperref[/T181/]{/181/} getestet.
\end{enumerate}
