...
\begin{enumerate}[label=\textbf{/T\arabic*0/}, align=left]
	...
	\item \label{/T130/} Testfall zu \hyperref[/FA14/]{/FA14/}: Auswählen von Gebäuden auf der \Gls{Karte} und Anzeigen von \gls{lokal} gespeicherten Informationen.
	\item \label{/T140/} Testfall zu \hyperref[/FA23/]{/FA23/}: Auswählen von Räumen auf der \Gls{Etagenkarte} und Anzeigen von \gls{lokal} gespeicherten Informationen.
