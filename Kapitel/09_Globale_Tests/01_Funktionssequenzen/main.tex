...
\begin{enumerate}[label=\textbf{/T\arabic*0/}, align=left]
	...
	\item[\textbf{/T120/}] \label{/T120/} Testfall zu \hyperref[/FA21/]{/FA21/}: Anzeige und Interaktion der \Gls{Etagenkarte}.
	...
	\item[\textbf{/T130/}] \label{/T130/} Testfall zu \hyperref[/FA14/]{/FA14/}: Auswählen von Gebäuden auf der \Gls{Karte} und Anzeigen von \gls{lokal} gespeicherten Informationen.
	\item[\textbf{/T140/}] \label{/T140/} Testfall zu \hyperref[/FA23/]{/FA23/}: Auswählen von Räumen auf der \Gls{Etagenkarte} und Anzeigen von \gls{lokal} gespeicherten Informationen.
	\item[\textbf{/T150/}] \label{/T150/} Testfall zu \hyperref[/FA22/]{/FA22/}: Wechseln der Etagen auf der \Gls{Etagenkarte}.
	\item[\textbf{/T160/}] \label{/T160/} Testfall zu \hyperref[/FA12/]{/FA12/}: Verschieben der \Gls{Karte} mit einem Finger.
	\item[\textbf{/T170/}] \label{/T170/} Testfall zu \hyperref[/FA13/]{/FA13/}: Hineinzoomen in die \Gls{Karte} durch Auseinanderführen von zwei Fingern.
	\item[\textbf{/T180/}] \label{/T180/} Testfall zu \hyperref[/FA13/]{/FA13/}: Herauszoomen aus der \Gls{Karte} durch Zusammenführen von zwei Fingern.
\end{enumerate}

\paragraph{\Gls{Benutzer} online, nicht angemeldet}
\begin{enumerate}[start=20, label=\textbf{/T\arabic*0/}, align=left]
