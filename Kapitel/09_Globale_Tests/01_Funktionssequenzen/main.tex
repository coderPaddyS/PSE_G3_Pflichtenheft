...
\begin{enumerate}[label=\textbf{/T\arabic*0/}, align=left]
	...
	\item \label{/T130/} Testfall zu \ref{/FA15/}: Auswählen von Gebäuden auf der \Gls{Karte}.
	...
	\item \label{/T160/} Testfall zu \ref{/FA13/}: Verschieben der \Gls{Karte} mit einem Finger.
	\item \label{/T170/} Testfall zu \ref{/FA14/}: Hineinzoomen in die \Gls{Karte} durch Auseinanderführen von zwei Fingern.
	\item \label{/T180/} Testfall zu \ref{/FA14/}: Herauszoomen aus der \Gls{Karte} durch Zusammenführen von zwei Fingern.
	\item \label{/T190/} Testfall zu \ref{/FA15/}: Anzeigen von \gls{lokal} gespeicherten Informationen zu dem ausgewählten Gebäude bzw. Raum.
\end{enumerate}
...
\begin{enumerate}[label=\textbf{/T\arabic*0/}, align=left, resume]
	...
	\item \label{/T220/} Testfall zu \ref{/FA15/}, \ref{/FA23/}: Anzeigen von allen Informationen zu dem ausgewählten Gebäude bzw. Raum.
