...
\begin{samepage}
    \begin{enumerate}[label=\textbf{/NFD\arabic*0/}, align=left, start=5]
        ...
        \item \label{/NFD60/} Es werden keine \Glspl{Benutzerdatum}, außer den folgenden, gespeichert:
            ...
            \end{itemize}
            Diese nicht funktionale Anforderung wird durch den Testfall \nameref{/TNFD60/} getestet.
        \item \label{/NFD70/} Der \Gls{Server} löscht abgelehnte \Glspl{Alias-Vorschlag} nach spätestens einer Woche. Diese nicht funktionale Anforderung wird durch den Testfall \nameref{/TNFD70/} getestet.
    \end{enumerate}
\end{samepage}
