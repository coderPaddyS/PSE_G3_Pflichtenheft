...
\begin{samepage}
    \begin{enumerate}[label=\textbf{/NFP\arabic*0/}, align=left, start=3]
        \item \label{/NFP30/} Das \Gls{Backend} lässt sicht in höchstens 10 Schritten installieren. \\
              Die Anzahl an Installationsschritten korreliert mit der Wahrscheinlichkeit des Auftreten eines Fehlers während der Installation. Diese nicht funktionale Anforderung wird durch den Testfall \nameref{/TNFP30/} getestet.
        ...
        \item \label{/NFP40/} Das \Gls{Backend} abstrahiert das zugrunde liegende \Gls{System} in einer \Gls{Schnittstelle}. Diese nicht funktionale Anforderung wird durch den Testfall \nameref{/TNFP40/} getestet.
    \end{enumerate}
\end{samepage}