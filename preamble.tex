...
\glossaryentry{Java}{Java}{Java ist eine Programmiersprache, die nicht auf eine spezifische Hardware kompiliert, sondern auf einen plattformunabhängigen Code, der von einer Java Virtual Machine auf einem spezifischen Gerät ausgeführt werden lkann. Java ist somit eine geeignete Wahl für Plattformübergreifende Entwicklung.}
...
\glossaryentry{Admin-Panel}{Admin-Panels}{Das Admin-Panel ist eine grafische Oberfläche zur Interaktion mit dem Backend. Dieses ist nur von privilegierten Nutzern, den Admins, benutzbar.}
...
\glossaryentry{API}{APIs}{"Eine Programmierschnittstelle, häufig nur kurz API genannt, ist ein Programmteil, der von einem Softwaresystem anderen Programmen zur Anbindung an das System zur Verfügung gestellt wird." (Wikipedia)}
...
\glossaryentry{Admin-Zugang}{Admin-Zugänge}{Einen Zugang zum System mit privilegierten Rechten, sogenannten Administratorrechte, kurz Adminrechte}
...
\glossaryentry{Admin}{Admins}{Administrator, Systemverwalter, privilegierter Benutzer}
