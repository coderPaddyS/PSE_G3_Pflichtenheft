...
\glossaryentry{Architekturstil}{Architekturstile}{Ein systematischer und strukturierter Aufbau eines Systems, hier Computersysteme, um Funktionalitäten bereitzustellen und leicht zu implementieren}
\aglossaryentry{Rueckwaertskompatibilitaet}{Rückwärtskompatibilität}{Rückwärtskompatibilitäten}{Wird ein System auf eine neue Version aktualisiert, können ältere Systeme wohlmöglich nicht mehr mit dem neuen System funktionieren. Eine rückwärtskompatible Versionsänderung gewährleistet die Funktionalität älterer Systeme bei Änderung zum neuen System.}
\glossaryentry{REST}{REST}{\textbf{RE}presentational \textbf{S}tate \textbf{T}ransfer ist ein \Gls{Architekturstil} für die Erstellung von \Gls{API}s. REST ist zustandslos, abgefragte Daten sind unabhängig von vorherigen Anfragen}
\glossaryentry{GraphQL}{GraphQL}{GraphQL ist eine \textbf{Q}uery \textbf{L}anguage, also eine Abfragesprache, die extra für \Gls{API}s entwickelt wurde und leichtere Abfragen ermöglicht mit besserer \Gls{Rueckwaertskompatibilitaet}}
...
\glossaryentry{Espresso}{Espresso}{Eine Android-Testumgebung. Mehr Informationen \footnote{\href{https://developer.android.com/training/testing/espresso/}{https://developer.android.com/training/testing/espresso/}}}
